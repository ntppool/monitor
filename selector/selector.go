...
// NewSelector creates a new selector instance. A non-nil settings watcher
// enables dynamic sample-count thresholds based on the current
// interval_testing; passing nil keeps the historical static thresholds
// (used by tests that don't need a live DB).
