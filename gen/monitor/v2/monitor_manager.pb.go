...
type GetConfigResponse struct {
	...
	OtlpLogLevel  string                 `protobuf:"bytes,6,opt,name=otlp_log_level,json=otlpLogLevel,proto3" json:"otlp_log_level,omitempty"` // Log level for OTLP stream (debug, info, warn, error)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetConfigResponse) GetOtlpLogLevel() string {
	if x != nil {
		return x.OtlpLogLevel
	}
	return ""
}
...
const file_monitor_v2_monitor_manager_proto_rawDesc = "" +
	...
	"\x06mon_id\x18\x01 \x01(\tR\x05monId\"\xea\x01\n" +
	...
	"mqttConfig\x12$\n" +
	"\x0eotlp_log_level\x18\x06 \x01(\tR\fotlpLogLevel\"^\n" +
	"\n" +
	"MQTTConfig\x12\x12\n" +
