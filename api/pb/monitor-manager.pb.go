...
type ServerList struct {
	...
	IPBytes [][]byte `protobuf:"bytes,2,rep,name=IPBytes,proto3" json:"IPBytes,omitempty"`
}
...
func (x *ServerList) GetIPBytes() [][]byte {
	if x != nil {
		return x.IPBytes
	}
	return nil
...
type ServerStatusList struct {
	...
	List []*ServerStatus `protobuf:"bytes,1,rep,name=List,proto3" json:"List,omitempty"`
}
...
type ServerStatus struct {
	...
	RTT        *durationpb.Duration   `protobuf:"bytes,4,opt,name=RTT,proto3" json:"RTT,omitempty"`
	Stratum    int32                  `protobuf:"varint,5,opt,name=Stratum,proto3" json:"Stratum,omitempty"`
	Leap       int32                  `protobuf:"zigzag32,6,opt,name=Leap,proto3" json:"Leap,omitempty"`
	Error      string                 `protobuf:"bytes,7,opt,name=Error,proto3" json:"Error,omitempty"`
	NoResponse bool                   `protobuf:"varint,8,opt,name=NoResponse,proto3" json:"NoResponse,omitempty"`
}
...
var file_monitor_manager_proto_rawDesc = []byte{
	...
	,
...
var file_monitor_manager_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_monitor_manager_proto_goTypes = []interface{}{
	...
	(*ServerList)(nil),            // 3: api.ServerList
	(*ServerStatusList)(nil),      // 4: api.ServerStatusList
	(*ServerStatusResult)(nil),    // 5: api.ServerStatusResult
	(*ServerStatus)(nil),          // 6: api.ServerStatus
	(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),   // 8: google.protobuf.Duration
}
var file_monitor_manager_proto_depIdxs = []int32{
	2, // 0: api.ServerList.config:type_name -> api.Config
	6, // 1: api.ServerStatusList.List:type_name -> api.ServerStatus
	7, // 2: api.ServerStatus.TS:type_name -> google.protobuf.Timestamp
	8, // 3: api.ServerStatus.Offset:type_name -> google.protobuf.Duration
	8, // 4: api.ServerStatus.RTT:type_name -> google.protobuf.Duration
	0, // 5: api.Monitor.GetConfig:input_type -> api.GetConfigParams
	1, // 6: api.Monitor.GetServers:input_type -> api.GetServersParams
	4, // 7: api.Monitor.SubmitResults:input_type -> api.ServerStatusList
	2, // 8: api.Monitor.GetConfig:output_type -> api.Config
	3, // 9: api.Monitor.GetServers:output_type -> api.ServerList
	5, // 10: api.Monitor.SubmitResults:output_type -> api.ServerStatusResult
